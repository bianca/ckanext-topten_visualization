...
Document any optional config settings here. For example::
    ...
    # (optional, default: 24).
    ckanext.topten_visualization.some_setting = some_default_value
...
coverage installed in your virtualenv (``pip install coverage``) then run::
    ...
    nosetests --nologcapture --with-pylons=test.ini --with-coverage --cover-package=ckanext.topten_visualization --cover-inclusive --cover-erase --cover-tests


---------------------------------
Registering ckanext-topten_visualization on PyPI
---------------------------------

ckanext-topten_visualization should be availabe on PyPI as
https://pypi.python.org/pypi/ckanext-topten_visualization. If that link doesn't work, then
...
----------------------------------------
Releasing a New Version of ckanext-topten_visualization
----------------------------------------

ckanext-topten_visualization is availabe on PyPI as https://pypi.python.org/pypi/ckanext-topten_visualization.
